...
RSpec.describe Item, type: :model do
  ...
  describe 'Class Methods' do
    before(:each) do
      @user_1 = User.create!(name: Faker::Name.name, address: Faker::Address.street_address, city: Faker::Address.city, state: Faker::Address.state_abbr, zipcode: Faker::Address.zip.to_i, email: "everythingisfine@gmail.com", password: Faker::Internet.password(7), role: 0)
  ...
  describe 'Instance Methods' do
    ...
    describe 'it should return the name of the merchant for an item' do
      ...
      it '.add_inventory' do
        ...
        expect(item_1.inventory_qty).to eq(14)
      end
    end
  end
end
