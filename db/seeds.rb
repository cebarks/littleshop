...
# Order.destroy_all
  ...
  item_17 = user_5.items.create!(name: "Whiskey Sour", description: "a mixed drink containing whiskey, lemon juice, sugar, and optionally, a dash of egg white.", image_url: "https://bit.ly/2LsUsLF", inventory_qty: rand(1..9999), price: Faker::Number.decimal(2))
